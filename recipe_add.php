...
<h1 xmlns="http://www.w3.org/1999/html">Dodaj recept</h1>
<form action="recipe_insert.php" method="post">
    ...
    <input type="number" name="level" min="1"max="5" placeholder="Vnesi zahtevnost repecepta" class="form-control" /><br/>
    <input type="number" name="number_of_people" min="1" max="20" placeholder="Vnesi števio oseb" class="form-control" /><br/>
    <textarea name="proceedings" placeholder="Vnesi postopek recepta" required="required" class="form-control">   </textarea> <br/>
    <textarea name="ingredients" placeholder="Vnesi sestavine" required="required" class="form-control"></textarea><br/>
