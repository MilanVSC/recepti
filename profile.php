...
$user = $stmt->fetch();
?>
<h1>Pozdravljen <?php echo $user ['first_name'];?> </h1>

<h2>Moji podatki</h2>
<form action="profile_update.php" method="post" enctype="multipart/form-data">
    <input type="text" name="first_name" value="<?php echo $user['first_name'];?>"  placeholder="Vnesi ime" required="required" class="form-control">
    <input type="text" name="last_name" value="<?php echo $user['last_name'];?>"  placeholder="Vnesi priimek" required="required" class="form-control">
...
<form action="password_change.php" method="post">
    <input type="password" name="old_pass" placeholder="Vnesi staro geslo" required="required" class="form-control"/><br />
